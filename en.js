export default {
  ...
  exploration_note: {
    ...
    "使用笔记时自动补充勾选": "Automatically select these when using the note",
    ...
    "在“标记”中选择使用笔记时需要自动勾选的内置分类。": "Under “Markers,” select the built-in categories to enable automatically when the note is used.",
    ...
    "尚未设置": "Not Set",
    "选择图标后点击开始，再点击地图放置点位。": "Select an icon, start drawing, then click the map to place a marker.",
